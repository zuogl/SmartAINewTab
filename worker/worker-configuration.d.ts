/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 940b311c65e5ec39b521443d58eb0e0a)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	BACKGROUNDS: R2Bucket;
	VAULTS: R2Bucket;
	DB: D1Database;
	PUBLIC_BASE_URL: string;
	ALLOWED_EXTENSION_ORIGINS: string;
	ALLOWED_EXTENSION_REDIRECT_URIS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "ALLOWED_EXTENSION_ORIGINS" | "ALLOWED_EXTENSION_REDIRECT_URIS" | "SESSION_TTL_DAYS" | "GOOGLE_TOKEN_URL" | "GOOGLE_JWKS_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
